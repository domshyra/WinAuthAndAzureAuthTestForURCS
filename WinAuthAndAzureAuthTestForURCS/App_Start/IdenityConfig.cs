...
namespace WinAuthAndAzureAuthTestForURCS.App_Start
{
    ...
    public class ApplicationUserManager : UserManager<IdentityModels.ApplicationUser>
    {
            ...
            IOwinContext context)
        {
            ApplicationUserManager manager =
                new ApplicationUserManager(new UserStore<IdentityModels.ApplicationUser>(context.Get<IdentityModels.ApplicationDbContext>()));
